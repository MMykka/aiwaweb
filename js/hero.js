        ...
        // OGL Library - Minimal imports needed
        class Renderer {
            constructor({ dpr = 1, canvas }) {
                this.dpr = dpr;
                this.canvas = canvas;
        ...
        class Triangle {
            constructor(gl) {
                this.gl = gl;
                this.position = new Float32Array([-1, -1, 3, -1, -1, 3]);
        ...
        class Mesh {
            ...
            draw() {
                ...
                for (let name in this.program.uniforms) {
                    ...
                    if (uniform.value instanceof Vec2) {
                ...
                const positionLocation = gl.getAttribLocation(this.program.program, 'position');
...
`;
        ...
        function initDarkVeil(canvas, options = {}) {
            const {
                hueShift = 38,
                noiseIntensity = 0,
                scanlineIntensity = 0,
